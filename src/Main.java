	...
	public static void main(String[] args) {
		...
		try {
			...
			String sql2 = "insert into g_artists (name, a_type, a_year, debut, regdate) "
					+"values ('이진아','여성','2010년대','2013년','2013-07-19 09:05:30');";
			...
			String sql3 = "update g_artists set a_year ='2000년대 ~'"
					+ "where a_year='2000년대';";
			int cnt3 = stat3.executeUpdate(sql3);//update된 것의 개수?
			if(cnt3>0) {
			...
			int cnt4 = stat4.executeUpdate(sql4);//update된 것의 개수?
			if(cnt4>0) {
